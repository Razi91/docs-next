...
Zauważ, że klikając w te przyciski, każdy zachowuje swoją odrębną wartość `count`. Dzieje się tak, ponieważ za każdym razem, gdy korzystasz z komponentu, tworzona jest jego nowa **instancja**.
...
Przykładowo, aplikacja może posiadać komponent Nagłówka, Paska Bocznego i Treści, na którą składają się z reguły inne komponenty dla linków nawigacyjnych, wpisów na blogu, itd.

Aby korzystać z tych komponentów w szablonach, muszą być one wcześniej zarejestrowane, aby Vue wiedziało o ich istnieniu. Są dwa sposoby rejestracji komponentów: **globalny** oraz **lokalny**. Do tej pory rejestrowaliśmy nasze komponenty globalnie, używając do tego metody `component` naszej aplikacji.
...
To wszystko, co musisz na ten moment wiedzieć o rejestrowaniu komponentów. Kiedy skończysz czytać tę stronę i opanujesz wszystkie poruszone zagadnienia, zalecamy powrócić do niej, aby przeczytać cały poradnik odnośnie [rejestracji komponentów](component-registration.md).
...
Gdy wartość jest przekazana atrybutowi z _props_, staje się on dostępny w instancji komponentu, również z poziomu szablonu, tak jak każda inna własność komponentu.
...
To wszystko, co musisz na ten moment wiedzieć `props`ach. Kiedy skończysz czytać tę stronę i opanujesz wszystkie poruszone zagadnienia, zalecamy powrócić do niej, aby przeczytać cały poradnik odnośnie [propsów](component-props.html).
...
Kiedy użyte na komponencie, `v-model` działa natomiast tak:
...
To wszystko, co musisz na ten moment wiedzieć o własnych zdarzeniach. Kiedy skończysz czytać tę stronę i opanujesz wszystkie poruszone zagadnienia, zalecamy powrócić do niej, aby przeczytać cały poradnik odnośnie [własnych zdarzeń](component-custom-events.md).
...
To wszystko, co musisz na ten moment wiedzieć o slotach. Kiedy skończysz czytać tę stronę i opanujesz wszystkie poruszone zagadnienia, zalecamy powrócić do niej, aby przeczytać cały poradnik odnośnie [slotów](component-slots.md).
...
To wszystko, co musisz na ten moment wiedzieć o dynamicznych komponentach. Kiedy skończysz czytać tę stronę i opanujesz wszystkie poruszone zagadnienia, zalecamy powrócić do niej, aby przeczytać cały poradnik odnośnie [dynamicznych i asynchronicznych komponentów](./component-dynamic-async.html).
